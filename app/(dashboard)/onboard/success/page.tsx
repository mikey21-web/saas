...
const NEXT_STEPS = [
  {
    ...
    desc: 'Upload your product catalog, FAQs, or paste your website URL',
    href: '#',
    action: 'knowledge',
  },
  {
    ...
    desc: 'Link your WhatsApp Business number to start receiving messages',
    href: '#',
    action: 'whatsapp',
  },
  {
    icon: '✉️',
    title: 'Set Up Email',
    desc: 'Connect your business email for auto-replies',
    href: '#',
    action: 'email',
  },
  {
    ...
    desc: 'Chat with your agent before going live',
    href: '#',
    action: 'test',
  },
]
...
export default function OnboardSuccessPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto text-center">
      {/* Celebration Header */}
      <div
        className={`transition-all duration-700 ${showConfetti ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
      >
        ...
        <p className="mb-8" style={{ color: '#71717a' }}>
          ...
          <br />
          No more missed leads, no more manual follow-ups.
        </p>
      </div>
      ...
      <div
        ...
        style={{ borderColor: 'rgba(255,255,255,0.08)', background: 'rgba(232,121,249,0.05)' }}
      >
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className="text-3xl">{icon}</div>
            <div>
              <h3 className="font-bold" style={{ color: '#f0eff0' }}>
                {agentName}
              </h3>
        ...
        <div className="grid grid-cols-3 gap-4 text-center">
          <div className="rounded-lg p-3" style={{ background: 'rgba(255,255,255,0.05)' }}>
            <p className="text-2xl font-bold" style={{ color: '#e879f9' }}>
              0
            </p>
            <p className="text-xs" style={{ color: '#71717a' }}>
              Conversations
      ...
      <div className="mb-8 text-left">
        <h2 className="font-bold mb-4 text-lg" style={{ color: '#f0eff0' }}>
          Complete setup to unlock full power:
        </h2>
          ...
          {NEXT_STEPS.map((step, i) => (
            ...
            >
              ...
              <div className="flex-1">
                <p className="font-semibold text-sm transition-colors" style={{ color: '#f0eff0' }}>
                  {step.title}
                </p>
                <p className="text-xs" style={{ color: '#71717a' }}>
                  {step.desc}
