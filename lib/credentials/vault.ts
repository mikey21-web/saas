...
export interface AgentCredentials {
  ...
  whatsapp_api_token?: string // encrypted WhatsApp API token
  ...
  use_diyaa_ai_powered?: boolean // opt-in to diyaa.ai hosted AI
  created_at: Date
  last_verified: Date
  last_rotated: Date
}
...
function resolveEncryptionKey(rawKey: string): Buffer {
  ...
  if (utf8.length !== 32) {
    throw new Error('ENCRYPTION_KEY must be 64-char hex or exactly 32 UTF-8 bytes')
  }
  return utf8
}
const ENCRYPTION_KEY_BUFFER = resolveEncryptionKey(ENCRYPTION_KEY)
